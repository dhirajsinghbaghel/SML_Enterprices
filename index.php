...
<head>
  ...
  <title>SML ENTERPRICES </title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link rel="icon" type="image/png" href="images/feviIcon.jpg">
  <link href="images/feviIcon.jpg" rel="apple-touch-icon">
...
?>
  ...
  <main class="main">
        ...
        <div class="row align-items-center gy-5">
          <div class="col-lg-7">
            <div class="hero-card shadow-sm" data-aos="fade-right" data-aos-delay="150">
              ...
              <div class="content">
                <h2 class="display-5 fw-bold mb-3">Automotive Instant Digital Lending Fintech Platform</h2>
                <p class="lead mb-4">SML ENTERPRICES ‘Click & Drive’ Technology connects the online to the physical world in the automotive lending ecosystem for dealers/channels, customers, and lenders, offering seamless solutions for used car finance and making vehicle purchasing more accessible and efficient for everyone involved.</p>
                <div class="d-flex flex-wrap gap-3">
                  <a href="#about" class="btn btn-primary-ghost">
                    <span>Explore Now</span>
                    <i class="bi bi-arrow-right ms-2"></i>
                  </a>
                  <a href="file:///C:/90shitsong/19818861-uhd_3840_2024_25fps.mp4" class="glightbox btn-video d-inline-flex align-items-center">
                ...
                <div class="mini-stats d-flex flex-wrap gap-4 mt-4" data-aos="zoom-in" data-aos-delay="250">
                  ...
                  <div class="stat d-flex align-items-center">
                    ...
                    <span>India's only</span>
                  </div>
                  <div class="stat d-flex align-items-center">
                    <i class="bi bi-people me-2"></i>
                    <span>27+Bank & Financers</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-5">
            <div class="media-stack" data-aos="zoom-in" data-aos-delay="200">
              <figure class="media primary shadow-sm">
                <img src="https://img.freepik.com/premium-vector/financial-services-financial-transaction-ecommerce-electronic-payments_569417-452.jpg" class="img-fluid" alt="Hero visual">
              </figure>
              <figure class="media secondary shadow-sm">
                <img src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202410/670765de37c0b-lenders-like-bajaj-finance-simplify-car-loan-borrowing-experience-by-offering-new-car-loans-102756836-16x9.jpg" class="img-fluid" alt="Supporting visual">
              </figure>
              <div class="floating-badge d-flex align-items-center shadow-sm" data-aos="fade-down" data-aos-delay="300">
                <i class="bi bi-award me-2"></i>
                <span>Your Journey to Instant Vehicle Finance</span>
              </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
          <div class="container section-title" data-aos="fade-up">
            <h2>Products</h2>
          <p>Kuwy's state-of-the-art innovations offer convenient solutions for dealers, customers, and lenders within the marketplace, including car loan for used cars.</p>
          </div
          <!-- Card 1 -->
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item">
              ...
              <h3>SML Elite</h3>
              <p>
                SML's state-of-the-art innovations offer convenient solutions for dealers, customers, and lenders within the marketplace, including car loan for used cars.
              </p>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item">
              ...
              <h3>SML  Laas</h3>
              <p>Browse your cars online and get your loan approved virtually.</p>
              <div class="card-links">
                <a href="#" class="link-item">
                  Learn More
                  <i class="bi bi-arrow-right"></i>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item">
              ...
              <h3>SML  Prime</h3>
              <p>Experience the ease of obtaining a vehicle loan for used cars through SML  while in our dealer's physical showroom.</p>
              <div class="card-links">
                <a href="#" class="link-item">
                  Learn More
                  <i class="bi bi-arrow-right"></i>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item">
              ...
              <h3>Karbureau</h3>
                <p>Make your car ready for the market with Kuwy's verified scores and used car finance solutions.</p>
                <div class="card-links">
                <a href="#" class="link-item">
                  Learn More
                  <i class="bi bi-arrow-right"></i>
          ...
          <div class="col-lg-5 order-lg-2" data-aos="fade-left" data-aos-delay="200">
            <aside class="showcase">
              <figure class="showcase-main">
                <img src="https://www.cashe.co.in/wp-content/uploads/2023/10/F8qMoA4p-Pre-Approved-Car-Loans.png" alt="Our Journey" class="img-fluid">
          ...
          <div class="col-lg-7 order-lg-1" data-aos="fade-right" data-aos-delay="200">
            <article class="intro-card">
              <div class="intro-head">
                ...
                <h2>What Is SML ENTERPRICES</h2>
              </div>

              <div class="intro-body">
                <p class="lead">
                  SML Enterprices is India's pioneering automotive fintech platform, uniquely connecting dealers, lenders, OEMs, and customers through a seamless digital interface. We simplify the process of obtaining auto loans, including vehicle loans for used cars, by offering end-to-end digital approval, processing, and disbursal. Our platform is not a lender or borrower; instead, we
                   facilitate your journey to secure the best financing options available
                </p>
                ...
                <div class="metric-band" data-aos="fade-up" data-aos-delay="350">
                  ...
                  <div class="metric">
                    ...
                    <span class="label">Loan Disbursal</span>
                  </div>
                  <div class="divider"></div>
                  <div class="metric">
                  ...
                  <div class="metric">
                    ...
                    <span class="label">Dealers & Channels</span>
                  </div>
                  <div class="divider"></div>
                  <div class="metric">
                    <span class="value">650+</span>
                    <span class="label">Locations Across India</span>
                  </div>
                </div>
    ...
    <section id="clients" class="clients section">
      <div class="container section-title" data-aos="fade-up">
        <h2>Partners</h2>
        <p>Your Dreams, Our Banking Partners’ Support</p>
      </div>
    ...
    <div class="clients-wrapper">
      <div class="clients-track">
        <div class="client-logo">
          <img src="images/banks/hero_fincorp.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/shriram_finance.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/hdbfs.webp" class="img-fluid" alt="Client 2" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/bandhanbank.webp" class="img-fluid" alt="Client 3" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/aubank.webp" class="img-fluid" alt="Client 4" loading="lazy">
        </div>


        <div class="client-logo">
          <img src="images/banks/icic_bank.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
      </div>
      <div class="clients-track">
        <div class="client-logo">
          <img src="images/banks/federal_bank.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/bajaj_finserv-w_1.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/mahindra_finance.webp" class="img-fluid" alt="Client 2" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/piramalfinance.webp" class="img-fluid" alt="Client 3" loading="lazy">
        </div>
        <div class="client-logo">
          <img src="images/banks/IKF.webp" class="img-fluid" alt="Client 4" loading="lazy">
        </div>


        <div class="client-logo">
          <img src="images/banks/aubank.webp" class="img-fluid" alt="Client 1" loading="lazy">
        </div>
      </div>
    </div>
              ...
              <div class="col-lg-7">
                <div class="text-content" data-aos="fade-right" data-aos-delay="200">
                  ...
                  <div class="action-group" data-aos="fade-up" data-aos-delay="450">
                    ...
                    <a href="file:///C:/90shitsong/19818861-uhd_3840_2024_25fps.mp4" class="btn btn-text-link glightbox">
...
?>
  ...
  <a href="#" id="scroll-top" class="scroll-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    <a href="https://wa.me/9479689809" id="whatsapp-top" class="d-flex align-items-center justify-content-center">
